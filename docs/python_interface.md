...
You can read about scenarios for using the `load`, `load_model_settings`, `get_X_from_predict_data` methods in [Description of the application life cycle](life_cycle.md#mlup.ml).
...
You can read about scenarios for using the `load`, `load_web_app_settings`, `run`, `stop` methods in [Description of the application life cycle](life_cycle.md#mlup.web).
